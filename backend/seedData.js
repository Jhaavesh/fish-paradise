...
const seeds = [
  ...
  { name:'Goldfish', category:'Live Fish', price:150, unit:'piece', badge:'Popular', featured:true, stock:40, imageUrl:'https://images.unsplash.com/photo-1571757767119-68b8dbed8d0a?w=400&q=70', description:'Beautiful beginner-friendly goldfish.' },

  { name:'Guppy', category:'Live Fish', price:80, unit:'pair', badge:'', featured:false, stock:60, imageUrl:'https://images.unsplash.com/photo-1522069169874-c58ec4b76be5?w=400&q=70', description:'Colorful guppy fish, ideal for small tanks.' },

  { name:'Betta', category:'Live Fish', price:250, unit:'piece', badge:'Best Seller', featured:true, stock:25, imageUrl:'https://images.unsplash.com/photo-1581888227599-779811939961?w=400&q=70', description:'Premium betta fish with vibrant colors.' },

  { name:'Arowana', category:'Live Fish', price:15000, unit:'piece', badge:'', featured:true, stock:5, imageUrl:'https://images.unsplash.com/photo-1560807707-8cc77767d783?w=400&q=70', description:'Exotic arowana fish for luxury aquariums.' },
];
